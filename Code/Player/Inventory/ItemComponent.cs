...
public class ItemComponent : Component
{
	...
	/// </summary>
	public PlayerBase LastOwner { get; set; }
	...
	protected override void OnStart()
	{
		...
		{
			Action = ( PlayerBase interactor, GameObject obj ) => interactor.Inventory.GiveItem( this ),
			Keybind = "use",
			Description = "Pickup",
	...
	protected override void OnDestroy()
	{
        ...
        PlayerBase.GetLocal()?.Inventory?.ClearItem( this );
	}
}
