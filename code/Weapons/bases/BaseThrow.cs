...
public class BaseThrow : WeaponComponent, IUse
{
	...
	public virtual void startPrepare()
	{
		...
		Sound.Play( activateSound, LocalPosition );
	...
	public virtual void createThrow(bool imidiantly)
	{
		...
		obj.NetworkSpawn();
		obj.LocalPosition = owner.CameraController.Camera.LocalPosition + owner.CameraController.Camera.LocalRotation.Forward * 50;
		obj.LocalRotation = owner.CameraController.Camera.LocalRotation;
		obj.Components.Get<Rigidbody>().Velocity = owner.CameraController.Camera.LocalRotation.Forward * 1000;
	...
	protected override void OnUpdate()
	{
		...
		if ( waitingThrow && curReleaseTime )
		{
			isPreparing = false;
			waitingThrow = false;
			Sound.Play( throwSound, LocalPosition );
